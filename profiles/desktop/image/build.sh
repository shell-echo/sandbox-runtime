...
case "$platform" in
    linux/amd64)
        ...
        archive_digest=591fef77f3bdbac861ef71ad7cfca7ef6e86a0ac092a7c10084118af10f40097
        ;;
    linux/arm64/v8)
        goarch=arm64
        base_digest=sha256:d858bb5442632a31bd4bca6c5e601dbe6b536fd7942092ea6a08a0a95805693c
        archive_digest=28468a7b60dc3228ae95f738e7083f6c41b02d381aa1ae6f42afe8424e9a4727
        ;;
    *)
