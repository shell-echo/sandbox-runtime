...
const (
	// ConfigEnvironment is retained because the locked gateway image consumes
	// this repository-private environment variable. It is not Browser authority.
...
func NormalizeDestinationHost(value string) (string, error) {
	return normalizeDestinationHost(value)
}
