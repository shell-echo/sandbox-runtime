// Package repository provides adapter-independent state for desktop handoff
// references.
package repository
...
func (s *State) FindRunning(source desktop.Record) (reference.Record, error) {
	s.ensureMap()
