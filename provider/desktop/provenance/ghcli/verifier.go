// Package ghcli verifies the locked Desktop image provenance with the GitHub
...
var (
	ErrInvalidOptions       = errors.New("invalid Desktop provenance verifier options")
	ErrVerificationFailed   = errors.New("Desktop image provenance verification failed")
...
func (v *Verifier) Verify(ctx context.Context, publication desktopimage.Publication) error {
	if ctx == nil {
...
func verificationArguments(publication desktopimage.Publication) []string {
	return []string{
...
func verifyOutput(output []byte, publication desktopimage.Publication) error {
...
func verifyIdentity(result verificationResult, publication desktopimage.Publication) error {
...
var _ desktopdocker.ProvenanceVerifier = (*Verifier)(nil)
