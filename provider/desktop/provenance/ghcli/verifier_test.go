...
func validVerification(publication desktopimage.Publication) verification {
				...
				Predicate: predicate{
					BuildDefinition: buildDefinition{
						...
						ExternalParameters: externalParameters{Workflow: workflowParameter{
							Path: ".github/workflows/desktop-image.yml", Ref: workflowRef, Repository: repositoryURL,
						}},
