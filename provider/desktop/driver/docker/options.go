...
// Desktop allocations. It is separate from the coding/shell lifecycle driver
...
const (
	DesktopRuntimeProfile = desktopimage.ProfileID
	DesktopUser           = "1000:1000"

	maxDesktopAllocations = 1_000
...
var (
	ErrInvalidDriver      = errors.New("invalid Provider Desktop Docker driver")
	ErrInvalidOptions     = errors.New("invalid Provider Desktop Docker options")
	ErrInvalidProvenance  = errors.New("invalid Provider Desktop image provenance")
	ErrNetworkUnavailable = errors.New("Provider Desktop restricted network is unavailable")
	ErrOwnershipConflict  = errors.New("Provider Desktop runtime ownership conflict")
	ErrInvalidRuntime     = errors.New("invalid Provider Desktop runtime")
...
type ProvenanceVerifier interface {
	Verify(context.Context, desktopimage.Publication) error
}
