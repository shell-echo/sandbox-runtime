...
func TestStartupIdentityStructuredCopyAndUniqueChannels(t *testing.T) {
	...
	if identity.ProtocolID != ProtocolID || identity.ProtocolVersion != ProtocolVersion ||
		...
		identity.ContractRevision != "98995384c60a924f25ca58d3b7e561207bfa5be8" || identity.ContractTree != "0a627baed11c8a6ddbe8a24bbc1869e4f85edc16" ||
		identity.ProfileID != "sandbox-runtime-external-caller-coding-shell-v1" || identity.ProfileVersion != "1.0.0" ||
		identity.ProfileDigest != "sha256:ed57cfcb72c60d3efe6aca872e50c38033200e0f1cb8d2ae076bf6593a0afce6" || identity.ExpectedValuesInjectedByHarness ||
