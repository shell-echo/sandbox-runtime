...
func TestLockedContractProjection(t *testing.T) {
	...
	factories := map[string]func() any{
		...
		"desktop-session-close-request.schema.json":      func() any { return &DesktopSessionCloseRequest{} },
		"desktop-session-handoff.schema.json":            func() any { return &DesktopSessionHandoff{} },
		"desktop-session-open-request.schema.json":       func() any { return &DesktopSessionOpenRequest{} },
	...
	if limits := projection.RequestBodyLimits(); !reflect.DeepEqual(limits, map[string]int64{
		...
		"desktop-session-close-request.schema.json": 65536,
		"desktop-session-open-request.schema.json":  65536,
	...
	fixtures := map[string]string{
		...
		"desktop-session-close-request.schema.json":      "desktop-session-close-request.json",
		"desktop-session-handoff.schema.json":            "desktop-session-handoff.json",
		"desktop-session-open-request.schema.json":       "desktop-session-open-request.json",
