...
- Product v1 Phase 3 is active with Slices 1-10 of 13 implemented. The current
  ...
  content-addressed transfers, and Workspace revision CAS as component and
  real-PostgreSQL evidence only.
