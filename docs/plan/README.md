...
| P2 | [Coding/remote-shell authority inventory](p2-coding-remote-shell.md) | P2.3c4 bounded Gateway evidence passed on `main@e675cb9`; post-push CI `32801539995` passed; P3 external-caller integration next |
