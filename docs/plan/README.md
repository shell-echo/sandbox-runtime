...
| P2 | [Coding/remote-shell authority inventory](p2-coding-remote-shell.md) | P2.3c0 passed in PR #44; P2.3c1 local domain/authority-port evidence passed with PR and merge gates pending |
