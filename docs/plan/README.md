...
| P2 | [Coding/remote-shell authority inventory](p2-coding-remote-shell.md) | Bounded slices through P2.5f7 have component/Contract/CI evidence; artifact/usage, readiness-derived advertisement, and independent caller E2E remain open |
| P2.5 | [Coding/shell vertical composition](p2.5-coding-shell-vertical-composition.md) | P2.5a-e pass through CI `32937530059`; P2.5f0-f5 retain their recorded local/CI gates; P2.5f6-f7 implementation through `0e8b284`, evidence baseline `cefbc74`, and CI `33134521467` pass, with P2.5g next |
