...
| P2.5 | [Coding/shell vertical composition](p2.5-coding-shell-vertical-composition.md) | P2.5a-e pass through CI `32937530059`; P2.5f0-f7 retain their recorded local/CI gates; P2.5g implementation `0e6e108` and CI `33157119149` pass; P2.5h implementation `2c55173` and CI `33159099578` pass; latest hosted co-located P2.5i reference caller evidence `330f629`/`9390554` passed run `33737531617` with 15+5 scenarios; real Agent Platform E2E, aggregate conformance, reliability, tenancy, deployment, and production gates remain open |
...
| P3 | [Migration readiness](p3-migration-readiness.md) | Local binding/shadow/metrics component evidence plus latest local and hosted candidate evidence `330f629`/`9390554` (15+5 scenarios; hosted run `33737531705`) exist; real platform shadow E2E, canary, rollback, drain, and migration gates remain blocked |
| P3 candidate | [Platform candidate caller](p3-platform-candidate-caller.md) | Candidate caller and Docker process harness passed locally and in hosted run `33737531705`; evidence remains distinct from real Veronica platform evidence |
...
| P4 Browser | [Optional Profiles](p4-optional-profiles.md) | Browser Contract/projection, exact sandboxed signed amd64/arm64/v8 image publication (`33724368530`), uncomposed session/reference/usage components, a fail-closed Docker adapter/private-relay component, real provenance verification (`9390554`, CI `33737531693`), restricted-egress provisioning, and immutable create-policy binding (`7e60340`) have named evidence; protected transport, caller-owned Gateway, advertisement, and Browser caller remain open |
