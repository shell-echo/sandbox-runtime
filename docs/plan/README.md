...
| P2.5 | [Coding/shell vertical composition](p2.5-coding-shell-vertical-composition.md) | P2.5a-c gates pass; P2.5d Provider runtime foundation passes locally with CI pending; P2.5e exec vertical is next after CI |
