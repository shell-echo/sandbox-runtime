...
| P3 | [Migration readiness](p3-migration-readiness.md) | Local binding/shadow/metrics component evidence, local candidate evidence `330f629`/`9390554`, and latest hosted candidate evidence `7f15628`/`7e60340` (15+5 scenarios; run `33747803514`) exist; real platform shadow E2E, canary, rollback, drain, and migration gates remain blocked |
