...
| P3 | [Migration readiness](p3-migration-readiness.md) | Local binding/shadow/metrics component evidence, local candidate evidence `330f629`/`9390554`, and latest hosted candidate evidence `a2721ad`/`b8423f5` (15+5 scenarios; run `33760609231`) exist; real platform shadow E2E, canary, rollback, drain, and migration gates remain blocked |
| P3 candidate | [Platform candidate caller](p3-platform-candidate-caller.md) | Candidate caller and Docker process harness passed locally and in hosted run `33747803514`; evidence remains distinct from real Veronica platform evidence |
