...
| P3 | [Migration readiness](p3-migration-readiness.md) | Local binding/shadow/metrics component evidence exists and the reference caller gate passes; actual Agent Platform E2E, real canary, rollback, drain, and migration gates remain open |
