...
| P4 Browser | [Optional Profiles](p4-optional-profiles.md) | Browser Contract/projection, sandboxed signed first image publication (`33721789424`), and uncomposed Provider-local session/reference/usage components have named evidence; exact arm64/v8 index correction `494401a` awaits republishing before runtime/transport/Gateway composition |
