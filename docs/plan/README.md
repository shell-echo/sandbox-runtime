...
| P3 | [Migration readiness](p3-migration-readiness.md) | Local binding/shadow/metrics component evidence and candidate integration evidence (`47bd627`, 15+5 scenarios) exist; real platform shadow E2E, canary, rollback, drain, and migration gates remain blocked |
| P3 candidate | [Platform candidate caller](p3-platform-candidate-caller.md) | Candidate caller and Docker process harness passed locally in `47bd627`; evidence remains distinct from real Veronica platform evidence |
