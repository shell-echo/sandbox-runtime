...
| P3 | [Migration readiness](p3-migration-readiness.md) | Local binding/shadow/metrics evidence, hosted candidate run `33940332881` against harness/Provider `6b01b75`/`997fb0d`, and current local candidate run `20260905T080623.861033000Z` against `59e08d5`/`c0a55d1` exist; real platform shadow E2E, canary, rollback, drain, and migration gates remain blocked |
| P3 candidate | [Platform candidate caller](p3-platform-candidate-caller.md) | Candidate caller and Docker process harness passed in hosted run `33940332881` against `6b01b75`/`997fb0d` and current local run `20260905T080623.861033000Z` against `59e08d5`/`c0a55d1`; evidence remains distinct from real Veronica platform evidence |
