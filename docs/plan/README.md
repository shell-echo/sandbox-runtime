...
| P3 | [Migration readiness](p3-migration-readiness.md) | Local binding/shadow/metrics component evidence exists and the reference caller gate passes; the 2026-08-31 platform audit found no runnable Agent Platform caller or migration harness, so real shadow E2E, canary, rollback, drain, and migration gates remain blocked |
| P3 candidate | [Platform candidate caller](p3-platform-candidate-caller.md) | In progress: build a separately executed candidate caller and migration harness; candidate integration evidence remains distinct from real Veronica platform evidence |
