...
| P2.6 | [Portable Provider conformance](p2.6-portable-provider-conformance.md) | In implementation under ADR 0039: content-derived local/remote Suite identity and a separate read-only remote discovery runner; independent-caller and broader readiness gates remain open |
