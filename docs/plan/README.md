...
| Phase | Plan | Status |
| --- | --- | --- |
| P1.1 | [Provider API admission](p1.1-provider-api-admission.md) | P1.1a-b implemented and verified; P1.1c token, digest, context, temporal, application gate, and single-controller guard checks implemented locally; release gate open |
| P1.1b | [mTLS capability discovery](p1.1b-capability-discovery.md) | Implemented and verified on `main`; CI acceptance closed |
| P1.1c | [Protected-operation admission](p1.1c-protected-operation-admission.md) | Admission interfaces, token/digest/context checks, pure application gate, and durable single-controller guard implemented locally; no protected route |
