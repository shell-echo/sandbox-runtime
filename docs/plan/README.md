...
| P2.6 | [Portable Provider conformance](p2.6-portable-provider-conformance.md) | Historical 50-case local and 6-case remote gates passed at `3fe314a`/`ae476fe`; the current content-derived 53-case local Suite, Contract checks, projections, race suite, and vet passed core CI `35204434771`. Protected/mutating remote and broader readiness gates remain separate |
