...
| P3 | [Migration readiness](p3-migration-readiness.md) | Local binding/shadow/metrics component evidence plus latest local candidate evidence `58ed009`/`c91d83f` and hosted evidence `e7e4d57`/`83a7884` (15+5 scenarios; run `33725664854`) exist; real platform shadow E2E, canary, rollback, drain, and migration gates remain blocked |
| P3 candidate | [Platform candidate caller](p3-platform-candidate-caller.md) | Candidate caller and Docker process harness passed locally and in hosted run `33725664854`; evidence remains distinct from real Veronica platform evidence |
