...
P2.6's local release gate is complete. The next slice is qualification of an
independently implemented caller against the exact locked standard. Any
protected or mutating remote profile must first define
