...
| Latest reference external-caller evidence | co-located `e2e/` harness `c7ff5eba6609bb0d047ab6d4cb1f6c53b09d27ed`; hosted run `33460370593` | Against Provider `d58497e`, all 15 initial and 5 process-reconstruction/resume scenarios passed over mTLS/JWS HTTPS, WebSocket, separate caller/reference-stack processes, and Docker. Hosted artifact `reference-e2e-evidence-33460370593` has digest `sha256:d48e67f20e15e6c0e7aa25713e25f0bab60ce2899e0c2dd9d3fbfd2acb0ea348`. This is P2.5i reference caller evidence only |
| Latest Agent Platform candidate integration evidence | candidate implementation `47bd627`; workflow/evidence baseline `c7ff5eba6609bb0d047ab6d4cb1f6c53b09d27ed`; hosted run `33460370618` | The independently named workflow passed lock verification, race/shuffle, vet, and `cmd/platform-e2e`. Downloaded evidence confirms 15 initial and 5 resume scenarios all passed and pins Provider `d58497e`, Contract 38 cases, separate `platform-caller`/`reference-stack` processes, and the candidate-only boundary. Artifact `platform-candidate-e2e-evidence-33460370618` has digest `sha256:54f0aea847dcb0b1808c6c902f1465979a3ec4362d52ab8884187e85ea6343f7`. This is candidate integration evidence only, not real Veronica or production evidence |
...
| P3 | Migration readiness and platform integration | Local component evidence (`4212e88`) plus local and Hosted Agent Platform candidate integration evidence (`47bd627`/`c7ff5eb`, 15+5 scenarios) are present; the reference P2 caller gate passes | Supply a real platform migration target and prove locked-Suite/request shadow parity, new-run-only canary, rollback, old-run drain, metric parity, and unchanged platform-owned contracts |
