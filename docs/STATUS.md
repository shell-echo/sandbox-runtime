...
| --- | --- | --- |
| Checkout | `main` | Current HEAD `bb402cb`; P3 migration component and ledger are pushed; docs post-push CI `32805509358` passed; Provider routes remain uncomposed and artifact/usage truth remains provider-local evidence only |
