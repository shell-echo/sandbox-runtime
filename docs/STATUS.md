...
| --- | --- | --- |
| Latest Provider implementation evidence | Contract `5096e71`; projection/lock `24b2e36`; browser session `9a5d225`; sandbox/provenance implementation `6e02f1c`; Browser adapter `cd33ba3`; Browser provenance verifier `9390554`; Browser restricted-egress/create-policy `7e60340`; protected transport `b8423f5`; caller-owned Gateway `5aae281`; default-disabled command graph `66183b1`; DNS compatibility Provider `f760369`; current E2E harness `79fee2b` | Locks Browser authority and composes the Provider-local graph without adding production advertisement or a Provider-owned public Gateway. Hosted Browser Reference E2E is recorded separately; real Agent Platform, aggregate, multi-controller, hostile multi-tenant, deployment, and production claims remain open |
...
| Browser-lock reference regression evidence | current hosted harness/Provider `79fee2b`/`f760369`, run `33838215917`; latest local run `20260904T013909.243838000Z` used earlier lock `9eb32ba`/`5aae281` | Hosted Reference E2E passed all 15 initial and 5 process-reconstruction/resume coding/shell scenarios. Artifact `reference-e2e-evidence-33838215917` has digest `sha256:77cd06014bc9ddf4c41130b1ccaf7b35210ebfbedf075662190500e708d23c2e`. This is coding/shell evidence, not Browser E2E |
| Browser-lock Agent Platform candidate regression evidence | current hosted harness/Provider `79fee2b`/`f760369`, run `33838215882`; latest local run `20260904T014037.825223000Z` used earlier lock `9eb32ba`/`5aae281` | Hosted candidate E2E passed all 15 initial plus 5 resume coding/shell scenarios, including candidate shadow/selection/rollback/drain policy and reconstruction. Artifact `platform-candidate-e2e-evidence-33838215882` has digest `sha256:9ad455bba6d61a082c2a5136fcf19c4609db6c759f035a0e5299ecc85f31e23e`. This is candidate integration only, not Browser evidence, real Veronica, or production evidence |
...
| P4 optional-profile authority | Contract `5096e71`; projection/lock `24b2e36`; 48-case Suite; command graph `66183b1`; Browser caller harness `79fee2b` | Browser-only capability, create/session/handoff, opaque reference, usage meter, security matrix, admission, default-disabled command composition, and hosted reference caller have named evidence. Production advertisement/public Gateway, remaining profile-specific security/concurrency, aggregate, multi-controller, tenant, deployment, and production gates remain open |
...
| P3 candidate integration evidence | current hosted harness/Provider `79fee2b`/`f760369`, run `33838215882`; latest local evidence `e2e/evidence/20260904T014037.825223000Z` used earlier lock `9eb32ba`/`5aae281` | Hosted current-lock candidate regression passed 15+5 coding/shell scenarios against Contract 48 cases. Artifact digest is `sha256:9ad455bba6d61a082c2a5136fcf19c4609db6c759f035a0e5299ecc85f31e23e`. Boundary is `Agent Platform candidate integration only`; real platform shadow parity, canary traffic, rollback/drain, and platform-contract ownership remain open |
| P2.5i reference external caller | current hosted harness/Provider `79fee2b`/`f760369`, run `33838215917`; latest local evidence `20260904T013909.243838000Z` used earlier lock `9eb32ba`/`5aae281` | Hosted current-lock run passed 15 initial plus 5 restart/resume coding/shell scenarios. Artifact digest is `sha256:77cd06014bc9ddf4c41130b1ccaf7b35210ebfbedf075662190500e708d23c2e`. It contains no Browser scenario and proves no Agent Platform, aggregate, multi-controller, hostile multi-tenant, deployment, or production property |
| P4 browser Contract authority and reference caller | Contract `5096e71`; projection/lock `24b2e36`; command `66183b1`; current harness/Provider `79fee2b`/`f760369`; hosted run `33838215924` | Browser authority, DTO projection, image/runtime components, default-disabled command graph, and 10 initial plus 5 reconstruction Browser reference-caller scenarios pass their named gates. The artifact digest is `sha256:4acfbc97c0c1f64e987b00870849a2244e33596918d08e659385c428310843ea`. Production advertisement/public Gateway, real platform, aggregate, multi-controller, hostile multi-tenant, deployment, and production evidence remain absent |
...
| P2.5i | Independent reference caller release gate | Hosted run `33838215917` with current harness/Provider `79fee2b`/`f760369` passed 15 initial and 5 restart/resume coding/shell scenarios; latest local run `20260904T013909.243838000Z` remains on earlier lock `9eb32ba`/`5aae281` | Hosted artifact digest is `sha256:77cd06014bc9ddf4c41130b1ccaf7b35210ebfbedf075662190500e708d23c2e`. Neither run contains a Browser scenario and neither may be promoted to Agent Platform, aggregate, multi-controller, hostile multi-tenant, deployment, or production evidence |
...
| P3 | Migration readiness and platform integration | Local component evidence (`4212e88`), latest local candidate integration (`20260904T014037.825223000Z`, earlier `9eb32ba`/`5aae281` lock), and hosted current-lock candidate run `33838215882` (`79fee2b`/`f760369`) are present; the reference P2 caller gate passes | Supply a real platform migration target and prove locked-Suite/request shadow parity, new-run-only canary, rollback, old-run drain, metric parity, and unchanged platform-owned contracts |
...
| P4 | Optional capability profiles | Browser Contract authority/projection, exact sandboxed signed linux/amd64 plus linux/arm64/v8 publication, Provider-local components, default-disabled command graph, and hosted 10+5 Browser reference caller have named evidence | Close remaining Browser profile-specific security/concurrency and deployment gates before any production advertisement; then begin the Desktop authority audit |
...
- Browser production advertisement and deployable public caller-owned Gateway,
  plus remaining profile-specific security, concurrency, capacity, distributed
  revocation, and operational evidence;
...
ADR 0026 and current harness/Provider lock `79fee2b`/`f760369` establish the
...
`sha256:4acfbc97c0c1f64e987b00870849a2244e33596918d08e659385c428310843ea`.
The inspected manifest pins the Contract/tree, 48-case Suite, signed Browser
image, verifier and configuration digests, reports, and evidence boundary. Its
two reports contain only passing scenarios, its Gateway audit is metadata-only,
and the runner asserts no managed runtime or support resources remain before
writing the manifest. Repository CI `33838215949` passed all four named jobs.
...
provenance, not as a local pass or code failure. Hosted run `33838215924`
provides the current complete Browser path evidence. Production Browser
advertisement and deployable caller-owned Gateway, real Agent Platform,
aggregate conformance, multi-controller reliability, hostile multi-tenant
security, deployment, and production readiness remain independent open gates.
