...
`34037307791`, Platform Candidate `34037307796`, Browser Reference
`34037307811`, shared capacity `34037307801`, durable revocation `34037307817`,
downstream-fencing v1 `34037307793`, downstream-fencing v2 `34037307798`,
PostgreSQL witness `34037307790`, and PostgreSQL controlled restore
`34037307799`. The controlled-restore run passes all 18 scenarios on
`linux/amd64`. Downloaded artifact
`browser-postgres-controlled-restore-e2e-evidence-34037307799` contains evidence
directory `20260906T135101.549639716Z` with exactly five sanitized files. Its
report records 18/18; its manifest records synthetic merge harness commit
`b924b26a7794e559a9694a648dea9711f316bd39`, three ingress reconstructions, all
...
`suite_exercised=false`. Artifact ID `9990655840` has digest
