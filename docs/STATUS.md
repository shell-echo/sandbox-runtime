...
| --- | --- | --- |
| Latest Provider implementation evidence | Contract `5096e71`; projection/lock `24b2e36`; browser session `9a5d225`; sandbox/provenance implementation `6e02f1c`; Browser adapter `cd33ba3`; Browser provenance verifier `9390554`; Browser restricted-egress/create-policy `7e60340`; protected transport `b8423f5`; caller-owned Gateway `5aae281`; default-disabled command graph `66183b1`; DNS compatibility Provider `f760369`; Browser Gateway local capacity `7b062e6`; Browser pre-upgrade edge `44ea2ee`; current E2E harness `249cdd4` | Locks Browser authority, composes the default-disabled Provider-local graph, bounds total/per-session Gateway connections inside one process, and adds process-local global connection/rate control before Browser WebSocket admission and upgrade without adding production advertisement or a Provider-owned public Gateway. Local Browser Reference E2E is recorded separately; hosted edge evidence, listener/TLS/HTTP controls, partition-aware shared capacity, distributed durable revocation, real Agent Platform, aggregate, multi-controller, hostile multi-tenant, deployment, and production claims remain open |
...
| Browser-lock reference regression evidence | hosted harness/Provider `28a9a5e`/`7b062e6`, run `33846603323`; latest local run `20260904T081521.464863000Z` uses current `249cdd4`/`44ea2ee` lock | Hosted and local Reference E2E each passed all 15 initial and 5 process-reconstruction/resume coding/shell scenarios. Hosted artifact `reference-e2e-evidence-33846603323` has digest `sha256:333be42b84c1d2ebfff86bae7d619348e84d13fe29b6f15975b587c2d38447c3`; the local run pins runtime digest `sha256:bcd5dbff8b2d108ee7dab464a85ee7d39ef74a8616a6af73a94ebb10ff8eaf75`. This is coding/shell evidence, not Browser E2E; hosted regression for the current lock is pending |
| Browser-lock Agent Platform candidate regression evidence | hosted harness/Provider `28a9a5e`/`7b062e6`, run `33846603454`; latest local run `20260904T081706.648122000Z` uses current `249cdd4`/`44ea2ee` lock | Hosted and local candidate E2E each passed all 15 initial plus 5 resume coding/shell scenarios, including candidate shadow/selection/rollback/drain policy and reconstruction. Hosted artifact `platform-candidate-e2e-evidence-33846603454` has digest `sha256:d3148037292f4e883dc96a1e224294f5841a4ae838bc1c8e2fe5e67455d39f95`; the local run pins runtime digest `sha256:bcd5dbff8b2d108ee7dab464a85ee7d39ef74a8616a6af73a94ebb10ff8eaf75`. This is candidate integration only, not Browser evidence, real Veronica, or production evidence; hosted regression for the current lock is pending |
...
| P4 optional-profile authority | Contract `5096e71`; projection/lock `24b2e36`; 48-case Suite; command graph `66183b1`; Browser capacity `7b062e6`; Browser edge `44ea2ee`; Browser caller harness `249cdd4` | Browser-only capability, create/session/handoff, opaque reference, usage meter, security matrix, admission, default-disabled command composition, process-local Gateway capacity, hosted 11+5 capacity caller evidence, and local 12+5 pre-upgrade edge caller evidence have named evidence. Hosted edge regression, production advertisement/public Gateway, listener/TLS/HTTP controls, partition-aware shared capacity, distributed durable revocation, remaining profile-specific security/concurrency, aggregate, multi-controller, tenant, deployment, and production gates remain open |
...
| P4 Browser pre-upgrade edge component and local caller evidence | ADR 0028; implementation `44ea2ee`; E2E lock `3b63c76`; harness `249cdd4`; local Browser run `20260904T080946.250607000Z` | Browser composition requires a process-local global connection/fixed-window request gate before WebSocket admission and upgrade. Focused/full race-shuffle, vet, Contract verification, the unchanged 48-case Suite, independent E2E module gates, and the clean local `linux/arm64` Browser run pass. The added 16-request authenticated wrong-Origin burst observes ordinary `403`, generic pre-upgrade `429` with bounded `Retry-After`, and recovery. All 12 initial and 5 reconstruction scenarios pass; the 20-record Gateway audit contains six `authorized`, six `connected`, four `client_closed`, and one each `capacity_rejected`, `denied`, `expired`, and `revoked`, with no `grant-browser-edge-*` identity. Hosted evidence is pending. This is a process-local Browser service plus local reference external-caller result only; listener/TLS/HTTP limits, partition-aware shared capacity, distributed durable revocation, production advertisement/public Gateway, real Agent Platform, aggregate, multi-controller, hostile multi-tenant, deployment, and production gates remain open |
...
| P3 candidate integration evidence | hosted harness/Provider `28a9a5e`/`7b062e6`, run `33846603454`; latest local evidence `e2e/evidence/platform-candidate/20260904T081706.648122000Z` uses current `249cdd4`/`44ea2ee` lock | Hosted and local candidate regressions passed 15+5 coding/shell scenarios against Contract 48 cases. Hosted artifact digest is `sha256:d3148037292f4e883dc96a1e224294f5841a4ae838bc1c8e2fe5e67455d39f95`; local runtime digest is `sha256:bcd5dbff8b2d108ee7dab464a85ee7d39ef74a8616a6af73a94ebb10ff8eaf75`. Boundary is `Agent Platform candidate integration only`; hosted current-lock regression, real platform shadow parity, canary traffic, rollback/drain, and platform-contract ownership remain open |
| P2.5i reference external caller | hosted harness/Provider `28a9a5e`/`7b062e6`, run `33846603323`; latest local evidence `20260904T081521.464863000Z` uses current `249cdd4`/`44ea2ee` lock | Hosted and local runs passed 15 initial plus 5 restart/resume coding/shell scenarios. Hosted artifact digest is `sha256:333be42b84c1d2ebfff86bae7d619348e84d13fe29b6f15975b587c2d38447c3`; local runtime digest is `sha256:bcd5dbff8b2d108ee7dab464a85ee7d39ef74a8616a6af73a94ebb10ff8eaf75`. It contains no Browser scenario and proves no Agent Platform, aggregate, multi-controller, hostile multi-tenant, deployment, or production property; hosted current-lock regression is pending |
| P4 browser Contract authority and reference caller | Contract `5096e71`; projection/lock `24b2e36`; command `66183b1`; capacity `7b062e6`; edge `44ea2ee`; current local harness/Provider `249cdd4`/`44ea2ee`; hosted capacity run `33846603547` | Browser authority, DTO projection, image/runtime components, default-disabled command graph, process-local post-authorization capacity, hosted 11+5 capacity scenarios, and local 12+5 pre-upgrade edge scenarios pass their named gates. Hosted capacity artifact digest is `sha256:b024225aa3545fa56a7cc5113f29c0817a86ebc70c3976e10d81bf3507546cba`. Hosted edge evidence, listener/TLS/HTTP limits, partition-aware shared capacity, distributed durable revocation, production advertisement/public Gateway, real platform, aggregate, multi-controller, hostile multi-tenant, deployment, and production evidence remain absent |
...
| P2.5i | Independent reference caller release gate | Hosted run `33846603323` with harness/Provider `28a9a5e`/`7b062e6` passed 15 initial and 5 restart/resume coding/shell scenarios; latest local run `20260904T081521.464863000Z` passes the same set on current `249cdd4`/`44ea2ee` lock | Hosted artifact digest is `sha256:333be42b84c1d2ebfff86bae7d619348e84d13fe29b6f15975b587c2d38447c3`; the local run pins runtime digest `sha256:bcd5dbff8b2d108ee7dab464a85ee7d39ef74a8616a6af73a94ebb10ff8eaf75`. Neither run contains a Browser scenario and neither may be promoted to Agent Platform, aggregate, multi-controller, hostile multi-tenant, deployment, or production evidence; hosted current-lock regression is pending |
...
| P3 | Migration readiness and platform integration | Local component evidence (`4212e88`), latest local candidate integration (`20260904T081706.648122000Z`, current `249cdd4`/`44ea2ee` lock), and hosted candidate run `33846603454` (earlier `28a9a5e`/`7b062e6` lock) are present; the reference P2 caller gate passes | Supply a real platform migration target and prove locked-Suite/request shadow parity, new-run-only canary, rollback, old-run drain, metric parity, and unchanged platform-owned contracts; hosted current-lock candidate regression is pending |
...
| P4 | Optional capability profiles | Browser Contract authority/projection, exact sandboxed signed linux/amd64 plus linux/arm64/v8 publication, Provider-local components, default-disabled command graph, process-local Gateway capacity, hosted 11+5 Browser capacity caller evidence, and local 12+5 pre-upgrade edge caller evidence have named evidence | Obtain hosted edge evidence, then close listener/TLS/HTTP, partition-aware shared capacity, distributed durable revocation, remaining hostile-tenant/operational, and deployment gates before any production advertisement; then begin the Desktop authority audit |
...
- P4 Browser Gateway local-capacity verification covers explicit valid total
  ...
  runs `33846603323`/`33846603454` also pass 15+5 against the same current lock;
...
- P4 Browser pre-upgrade edge verification covers explicit bounded
  ...
  Hosted workflows for this lock are pending. The Browser result is
  process-local edge plus local Browser reference external-caller evidence,
...
- Browser production advertisement and deployable public caller-owned Gateway,
  plus listener/TLS/HTTP limits, authenticated partition-aware shared or
  distributed capacity, durable distributed revocation, production
  storage/configuration, hostile-tenant, and operational evidence;
...
per-session Browser Gateway connection capacity. Current harness `28a9a5e`
...
and upgrade. Harness `249cdd4` actively exercises that boundary. Clean local
Browser run `20260904T080946.250607000Z` passed all 12 initial and 5
...
separate 15+5 coding/shell regressions against the same lock. Hosted workflows
for this implementation and harness have not yet run.
...
`33846603547` provides the complete Browser reference path and process-local
post-authorization capacity evidence; the current local 12+5 run adds only the
process-local service edge described above. Hosted edge evidence,
listener/TLS/HTTP limits, authenticated partition-aware shared or distributed
capacity, durable distributed revocation, production storage/configuration,
production Browser advertisement and deployable caller-owned Gateway, real
Agent Platform, aggregate conformance, multi-controller reliability, hostile
multi-tenant security, deployment, and production readiness remain independent
open gates.
