...
| P2.5i | Independent reference caller release gate | Hosted run `33708670563` with clean co-located harness `75e5725` passed Provider lock `4df7f22`, recording 15 initial and 5 restart/resume coding/shell passes | Artifact digest is `sha256:36596ce808833b12cfcab44277d1acc1715c559608c5e2b57293f00d5e3af961`. The run contains no browser scenario and must not be promoted to Agent Platform, aggregate, multi-controller, hostile multi-tenant, deployment, or production evidence |
