...
gates only. Next work is durable distributed revocation and downstream fencing,
Valkey provenance and HA/failover consistency, production storage/configuration
and metrics, hostile-tenant and operational evidence, and production Browser
