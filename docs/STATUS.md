...
| --- | --- | --- |
| Checkout | `main` | P3 migration component and ledger are pushed at `bb402cb`; docs CI `32806236192` passed; Provider routes remain uncomposed and artifact/usage truth remains provider-local evidence only |
