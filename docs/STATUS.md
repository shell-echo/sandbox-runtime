...
Product v1 Phase 4 Browser is in progress at **3/13**. Slices 1-3 add Product
Browser session/slot authority, exact kind/profile validation, bounded tenant
quota, an absorbing state machine, isolated dispatch, and an exact-revision
network-only Provider adapter for restricted sandbox creation and opaque
handoff observation. Ten slices remain, including lifecycle cleanup, public
automation/live data planes, controller/viewer policy, recovery, isolation,
recording, Web, cleanup, and the independent-process release gate. No Product
Browser capability readiness or phase-completion claim follows.
...
| Current Provider Contract authority | Revision `98995384c60a924f25ca58d3b7e561207bfa5be8`; tree `0a627baed11c8a6ddbe8a24bbc1869e4f85edc16`; manifest `sha256:f1a4e787f5dc5fecc85c6f6ed54385925686dfc1ced749caca5522805320c799`; 60-case local Suite `sha256:7db1d28d35ca193632c395247cc71eeaaff48b027964b9ea9da247eaad5e3991`; unchanged 6-case remote Suite | Lock-selection revision `3caf38c6bc0b62d2eeb2c1e1c4ed473fae5baab1` passed the exact Contract/profile verification, full root and E2E race/vet gates, eight E2E checks, a clean VCS-built shuffled/race-enabled 60-case local Suite, and tagged Docker lifecycle integration. Historical hosted CI and remote discovery results retain their recorded identities and are not relabeled by this local release result |
...
| Contract lock | format 2; revision `98995384c60a924f25ca58d3b7e561207bfa5be8`; tree `0a627baed11c8a6ddbe8a24bbc1869e4f85edc16`; manifest `sha256:f1a4e787f5dc5fecc85c6f6ed54385925686dfc1ced749caca5522805320c799`; OpenAPI `sha256:f4301829d52969516d8551e14b7aee064628bec01e1d7d3613be3fa89579efdb`; semantic rules `sha256:0bf737c9dc242a0a7e32a1a86261fa1fc96b3124eeb2510738af274de53a2026` | The Provider Calling Standard is a manifest resource. Both Suite digests are content-derived with `rfc8785-full-document-excluding-suite-digest-v1`. Local `sandbox-provider@1.0.0` / `sandbox-runtime-provider-v1` has 60 cases and digest `sha256:7db1d28d35ca193632c395247cc71eeaaff48b027964b9ea9da247eaad5e3991`; remote `sandbox-provider-remote@1.0.0` / `sandbox-runtime-provider-remote-discovery-v1` has six cases and digest `sha256:167922d972229a97a64bf22bc6a36ee20d4de19a023395d9f004f00c54cc49d0` |
...
For the current 60-case authority, the Phase 2 local release gate passed the
