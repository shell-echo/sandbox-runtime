...
| P1.2.5a | Provider lifecycle composition | PR #27 open; CI `32437596482` passed and `32437697554` in progress | Review, latest PR CI, post-merge CI, then retain fake-driver and production-readiness boundaries |
