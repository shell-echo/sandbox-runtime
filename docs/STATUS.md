...
| --- | --- | --- |
| Latest Provider implementation evidence | Contract `5096e71`; projection/lock `24b2e36`; browser session `9a5d225`; sandbox/provenance implementation `6e02f1c`; Browser adapter `cd33ba3`; Browser provenance verifier `9390554`; Browser restricted-egress/create-policy `7e60340`; protected transport `b8423f5`; caller-owned Gateway `5aae281`; default-disabled command graph `66183b1`; DNS compatibility Provider `f760369`; Browser Gateway local capacity `7b062e6`; Browser pre-upgrade edge `44ea2ee`; Browser public TLS edge `b8f8941`; authenticated capacity `997fb0d`; Redis-compatible shared capacity `9434540`; exact-grant revocation component `c0a55d1`; earlier E2E lock `59e08d5`; durable-revocation harness/Gateway `e952ef9`; repository CI `33959122462`; hosted durable run `33959122456`; downstream CDP fencing component `b4d41c9` | Locks Browser authority, composes the default-disabled Provider-local graph, bounds process-local Gateway/pre-upgrade/listener work, adds caller-owned authenticated-capacity, exact-grant revocation, and downstream action-fence ports, and implements Redis-compatible shared-capacity, retained-revocation, and exact-member/high-water adapters. Repository CI `33959122462` passes `provider-contract`, `test`, `browser-provenance`, and `docker-integration` for the earlier durable-revocation harness baseline. Separately named Reference/Candidate/Browser/shared-capacity and durable-revocation evidence tracks retain their recorded boundaries. ADR 0033 targeted/full race-shuffle, vet, Contract verification, unchanged locked 48-case Suite, and tagged pinned-Valkey integration pass only its component plus real-backend adapter integration gate. The independent two-Gateway/unique-ingress/real-Chromium external-caller gate, private authenticated ingress topology, missing-high-water/restore controls, production advertisement/public Gateway, Valkey provenance/HA/failover, production metrics/configuration/deployment, real Agent Platform, aggregate, multi-controller, hostile multi-tenant, and production readiness remain open |
...
| Browser-lock reference regression evidence | hosted harness/Provider `c7fe24d`/`c0a55d1`, run `33955436969`; current local harness/Provider `59e08d5`/`c0a55d1`, run `20260905T080530.577843000Z` | Hosted and current local Reference E2E each passed all 15 initial and 5 process-reconstruction/resume coding/shell scenarios. Hosted artifact `reference-e2e-evidence-33955436969` has digest `sha256:68642bb9810b397fada89bdb2666c11d46ddc0961eec6d6fd7d5e826e7336a70`; the local run pins runtime digest `sha256:c1da999518ed8cf3c422142b705f3eeca5d60104be07bc28c15a7d527d2907fc`. This is coding/shell regression evidence, not Browser E2E or durable-revocation caller evidence |
| Browser-lock Agent Platform candidate regression evidence | hosted harness/Provider `c7fe24d`/`c0a55d1`, run `33955437046`; current local harness/Provider `59e08d5`/`c0a55d1`, run `20260905T080623.861033000Z` | Hosted and current local candidate E2E each passed all 15 initial plus 5 resume coding/shell scenarios, including candidate shadow/selection/rollback/drain policy and reconstruction. Hosted artifact `platform-candidate-e2e-evidence-33955437046` has digest `sha256:2b745f256e4a0e1bdfa46c5129b1d92548a6f7afd2630a0c0720eb552ed35147`; the local run pins runtime digest `sha256:c1da999518ed8cf3c422142b705f3eeca5d60104be07bc28c15a7d527d2907fc`. This is candidate integration only, not Browser evidence, real Veronica, durable-revocation caller evidence, or production evidence |
...
| P4 optional-profile authority | Contract `5096e71`; projection/lock `24b2e36`; 48-case Suite; command graph `66183b1`; Browser capacity `7b062e6`; Browser edge `44ea2ee`; Browser TLS edge `b8f8941`; authenticated capacity `997fb0d`; Redis-compatible capacity `9434540`; ADR 0032 revocation component `c0a55d1`; durable-revocation harness/Gateway `e952ef9`; hosted run `33959122456`; ADR 0033 downstream fencing `b4d41c9` | Browser-only capability, create/session/handoff, opaque reference, usage meter, security matrix, admission, default-disabled command composition, process-local Gateway/pre-upgrade/listener limits, hosted 13+5 Browser caller evidence, local arm64 plus hosted amd64 10/10 real-Valkey two-Gateway shared-capacity evidence, exact-grant revocation component evidence, local plus hosted 7/7 durable-revocation caller evidence, and downstream action-fence/private-ingress/Redis adapter component evidence have named boundaries. ADR 0033 has no external-caller E2E. Its independent two-Gateway/unique-ingress/real-Chromium caller gate, private authenticated ingress topology, missing-high-water/restore controls, Valkey provenance/HA/failover, production storage/configuration/metrics/deployment, remaining profile-specific security/concurrency, aggregate, multi-controller, hostile multi-tenant, real Agent Platform, and production gates remain open |
...
| P4 Browser downstream CDP fencing component | ADR 0033; implementation `b4d41c9`; pinned Valkey index `sha256:ccfa19b0d743e48927e1c8c14e39e0acb97b5cea347fef0bfe340247fea920cd` | Narrow opaque action-fence and fenced-resolver ports, Redis-compatible exact-member/session-high-water authorization, a complete-message private ingress state machine, and fail-closed Browser composition pass targeted/full race-shuffle, vet, Contract verification, the unchanged locked 48-case Suite, and tagged real-Valkey integration. This closes only the component plus real-backend adapter integration gate. No independent two-Gateway/unique-ingress/real-Chromium external caller has run. Private authenticated ingress topology, missing-high-water/restore controls, Valkey provenance/HA/failover, production metrics/configuration/deployment, Provider multi-controller reliability, hostile multi-tenant isolation, real Agent Platform compatibility, aggregate conformance, and production readiness remain unproved |
...
| P3 candidate integration evidence | hosted harness/Provider `c7fe24d`/`c0a55d1`, run `33955437046`; current local harness/Provider `59e08d5`/`c0a55d1`, evidence `e2e/evidence/platform-candidate/20260905T080623.861033000Z` | Hosted and current local candidate regressions passed 15+5 coding/shell scenarios against Contract 48 cases. Hosted artifact digest is `sha256:2b745f256e4a0e1bdfa46c5129b1d92548a6f7afd2630a0c0720eb552ed35147`; local runtime digest is `sha256:c1da999518ed8cf3c422142b705f3eeca5d60104be07bc28c15a7d527d2907fc`. Boundary is `Agent Platform candidate integration only`; real platform shadow parity, canary traffic, rollback/drain, and platform-contract ownership remain open |
| P2.5i reference external caller | hosted harness/Provider `c7fe24d`/`c0a55d1`, run `33955436969`; current local harness/Provider `59e08d5`/`c0a55d1`, evidence `20260905T080530.577843000Z` | Hosted and current local runs passed 15 initial plus 5 restart/resume coding/shell scenarios. Hosted artifact digest is `sha256:68642bb9810b397fada89bdb2666c11d46ddc0961eec6d6fd7d5e826e7336a70`; local runtime digest is `sha256:c1da999518ed8cf3c422142b705f3eeca5d60104be07bc28c15a7d527d2907fc`. It contains no Browser scenario and proves no Agent Platform, durable-revocation caller, aggregate, multi-controller, hostile multi-tenant, deployment, or production property |
| P4 browser Contract authority and reference caller | Contract `5096e71`; projection/lock `24b2e36`; command `66183b1`; capacity `7b062e6`; service edge `44ea2ee`; TLS edge `b8f8941`; authenticated capacity `997fb0d`; hosted Browser run `33955436984`; shared adapter `9434540`; local shared run `20260905T080725.227680000Z`; hosted shared run `33955436968`; revocation component `c0a55d1`; durable harness `e952ef9`; hosted durable run `33959122456`; downstream fencing component `b4d41c9` | Browser authority, DTO projection, image/runtime components, default-disabled command graph, process-local Gateway limits, hosted 13+5 Browser scenarios with authenticated memory capacity, local arm64 plus hosted amd64 10/10 real-Valkey two-Gateway shared-capacity scenarios, exact-grant revocation component tests, local plus hosted seven-case two-Gateway/independent-revoker caller evidence, and downstream fencing component/real-backend adapter integration pass within their names. These evidence tracks remain separate. The ADR 0033 two-Gateway/unique-ingress/real-Chromium external-caller gate, private authenticated ingress topology, missing-high-water/restore controls, Valkey provenance/HA/failover, production storage/configuration/metrics/deployment, real platform, aggregate, multi-controller, hostile multi-tenant, and production evidence remain absent |
...
| P2.5i | Independent reference caller release gate | Hosted run `33955436969` with harness/Provider `c7fe24d`/`c0a55d1` passed 15 initial and 5 restart/resume coding/shell scenarios; current local run `20260905T080530.577843000Z` passes the same set on `59e08d5`/`c0a55d1` | Hosted artifact digest is `sha256:68642bb9810b397fada89bdb2666c11d46ddc0961eec6d6fd7d5e826e7336a70`; the local run pins runtime digest `sha256:c1da999518ed8cf3c422142b705f3eeca5d60104be07bc28c15a7d527d2907fc`. Neither run contains a Browser scenario and neither may be promoted to Agent Platform, durable-revocation caller, aggregate, multi-controller, hostile multi-tenant, deployment, or production evidence |
...
| P3 | Migration readiness and platform integration | Local component evidence (`4212e88`), current local candidate integration (`20260905T080623.861033000Z`, `59e08d5`/`c0a55d1` lock), and hosted candidate run `33955437046` (`c7fe24d`/`c0a55d1` lock) are present; the reference P2 caller gate passes | Supply a real platform migration target and prove locked-Suite/request shadow parity, new-run-only canary, rollback, old-run drain, metric parity, and unchanged platform-owned contracts |
...
| P4 | Optional capability profiles | Browser Contract authority/projection, exact sandboxed signed linux/amd64 plus linux/arm64/v8 publication, Provider-local components, default-disabled command graph, process-local Gateway limits, hosted 13+5 Browser caller run `33955436984`, local arm64 plus hosted amd64 10/10 real-Valkey two-Gateway shared-capacity evidence through run `33955436968`, ADR 0032 exact-grant revocation component and caller evidence, and ADR 0033/`b4d41c9` downstream fencing component plus real-backend adapter integration have named boundaries | Run the independent ADR 0033 two-Gateway/unique-ingress/real-Chromium external-caller gate, then close private-ingress topology, high-water/restore, Valkey provenance/HA, production configuration/metrics, hostile-tenant/operational, and deployment gates before any production advertisement or Desktop authority audit |
...
- P4 Browser exact-grant revocation verification covers the atomic
  ...
  `20260905T080725.227680000Z` passes 10/10 on arm64. These are current-lock
...
- Hosted current-lock repository CI `33955437033` passes `provider-contract`,
  ...
  This is repository CI plus separately named current-lock regression evidence,
...
- ADR 0033 and implementation `b4d41c9` add narrow downstream action-fence and
  ...
  gate. The independent two-Gateway/unique-ingress/real-Chromium external-caller
  E2E has not run. Private authenticated ingress topology,
  missing-high-water/restore controls, Valkey provenance/HA/failover,
  production metrics/configuration/deployment, Provider multi-controller,
  hostile multi-tenant, real Agent Platform, aggregate conformance, and
...
- the independent ADR 0033 two-Gateway/unique-ingress/real-Chromium
  external-caller gate; private authenticated unique-ingress topology and
  missing-high-water/restore controls; Browser production advertisement and
  deployable public caller-owned Gateway; Valkey provenance and HA/failover
  consistency; production storage/configuration and metrics; and hostile-tenant
...
current local Browser 13+5, Reference/Candidate 15+5, and shared-capacity 10/10
regressions pass. Hosted CI `33955437033` also passes at repository revision
`c7fe24d`. Four current-lock regressions pass with harness `c7fe24d` locked to
...
integration against pinned Valkey index
`sha256:ccfa19b0d743e48927e1c8c14e39e0acb97b5cea347fef0bfe340247fea920cd`.
This closes only its component plus real-backend adapter integration gate.
Next work is its independent two-Gateway/unique-ingress/real-Chromium
external-caller harness and gate, not Valkey provenance, HA/failover,
production topology, or platform evidence. Private authenticated ingress
topology, missing-high-water/restore controls, production storage/configuration
and metrics, hostile-tenant and operational evidence, production Browser
advertisement/public Gateway, real Agent Platform, aggregate, multi-controller,
