...
| Browser-lock reference regression evidence | latest local harness/Provider `330f629`/`9390554`, run `20260903T091011.164430000Z`; hosted harness/Provider `7f15628`/`7e60340`, run `33747803507` | Local and hosted Reference E2E passed all 15 initial and 5 process-reconstruction/resume coding/shell scenarios. Artifact `reference-e2e-evidence-33747803507` digest is `sha256:c0cf1f430bef0f354423412a15db0de5b6fce0201c3a583402b7fa9dcfc233ad`; its manifest pins Contract 48 cases. This is reference coding/shell evidence, not Browser E2E |
| Browser-lock Agent Platform candidate regression evidence | latest local harness/Provider `330f629`/`9390554`, run `20260903T091045.591005000Z`; hosted harness/Provider `7f15628`/`7e60340`, run `33747803514` | Local and hosted candidate E2E passed all 15 initial plus 5 resume coding/shell scenarios, including candidate shadow/selection/rollback/drain policy and reconstruction. Artifact `platform-candidate-e2e-evidence-33747803514` digest is `sha256:3f85c05e23d84f00d88b41302f7d8fd401579bd7ab07b2464d1f346388eb1f5c`. This is candidate integration only, not Browser evidence, real Veronica, or production evidence |
...
| P3 candidate integration evidence | latest local harness/Provider `330f629`/`9390554`, evidence `e2e/evidence/platform-candidate/20260903T091045.591005000Z`; hosted harness/Provider `7f15628`/`7e60340`, run `33747803514` | Current local and hosted candidate lock regressions pass 15+5 coding/shell scenarios against Contract 48 cases. Hosted artifact digest is `sha256:3f85c05e23d84f00d88b41302f7d8fd401579bd7ab07b2464d1f346388eb1f5c`. Boundary is `Agent Platform candidate integration only`; Browser scenarios, real platform shadow parity, canary traffic, rollback/drain, and platform-contract ownership remain open |
| P2.5i reference external caller | latest local harness/Provider `330f629`/`9390554`, evidence `20260903T091011.164430000Z`; hosted harness/Provider `7f15628`/`7e60340`, run `33747803507` | Local and hosted runs passed 15 initial plus 5 restart/resume coding/shell scenarios. Hosted artifact digest is `sha256:c0cf1f430bef0f354423412a15db0de5b6fce0201c3a583402b7fa9dcfc233ad`. They contain no Browser scenario and prove no Agent Platform, aggregate, multi-controller, hostile multi-tenant, deployment, or production property |
| P4 browser Contract authority | Contract `5096e71`; projection/lock `24b2e36`; E2E lock `7f15628` | Browser-only capability/create/session/handoff/usage/security/admission authority, DTO projection, fail-closed shapes, route absence, and 10 new Suite cases pass locally. The image and uncomposed Provider-local session, Docker/private-relay, provenance, and restricted-egress components are recorded separately; handler, advertisement, caller-owned Gateway, and Browser E2E remain absent |
...
| P2.5i | Independent reference caller release gate | Hosted run `33747803507` with clean co-located harness `7f15628` passed Provider lock `7e60340`, recording 15 initial and 5 restart/resume coding/shell passes | Artifact digest is `sha256:c0cf1f430bef0f354423412a15db0de5b6fce0201c3a583402b7fa9dcfc233ad`. The run contains no Browser scenario and must not be promoted to Agent Platform, aggregate, multi-controller, hostile multi-tenant, deployment, or production evidence |
...
| P3 | Migration readiness and platform integration | Local component evidence (`4212e88`) plus latest local candidate integration (`20260903T091045.591005000Z`, `330f629`/`9390554`, 15+5 coding/shell) and hosted candidate regression (`33747803514`, `7f15628`/`7e60340`) are present; the reference P2 caller gate passes | Supply a real platform migration target and prove locked-Suite/request shadow parity, new-run-only canary, rollback, old-run drain, metric parity, and unchanged platform-owned contracts |
...
`24b2e36`; latest hosted E2E evidence `7f15628`/`7e60340` and latest local
...
remains local single-controller component/lifecycle-binding evidence.
Protected/Gateway
