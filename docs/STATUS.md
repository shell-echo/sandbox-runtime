...
Product v1 Phase 4 Browser is in progress at **1/13**. Slice 1 adds Product
Browser session authority, exact Product kind/profile validation, ready
Browser-slot/capability binding, an absorbing state machine, PostgreSQL
profile constraints, and Browser-specific outbox isolation. Twelve slices
remain, including Browser slot reconciliation, Provider adaptation, public
