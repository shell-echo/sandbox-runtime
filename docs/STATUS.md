...
| --- | --- | --- |
| Latest Provider implementation evidence | Contract `5096e71`; projection/lock `24b2e36`; browser session `9a5d225`; sandbox/provenance implementation `6e02f1c`; Browser adapter `cd33ba3`; Browser provenance verifier `9390554`; Browser restricted-egress/create-policy `7e60340`; protected transport `b8423f5`; caller-owned Gateway `5aae281`; default-disabled command graph `66183b1`; DNS compatibility Provider `f760369`; Browser Gateway local capacity `7b062e6`; Browser pre-upgrade edge `44ea2ee`; hosted E2E harness `e7e7f03` | Locks Browser authority, composes the default-disabled Provider-local graph, bounds total/per-session Gateway connections inside one process, and adds process-local global connection/rate control before Browser WebSocket admission and upgrade without adding production advertisement or a Provider-owned public Gateway. Hosted Browser Reference E2E is recorded separately; listener/TLS/HTTP controls, partition-aware shared capacity, distributed durable revocation, real Agent Platform, aggregate, multi-controller, hostile multi-tenant, deployment, and production claims remain open |
...
| Browser-lock reference regression evidence | hosted harness/Provider `e7e7f03`/`44ea2ee`, run `33854020874`; latest local run `20260904T081521.464863000Z` uses `249cdd4`/`44ea2ee` lock | Hosted and local Reference E2E each passed all 15 initial and 5 process-reconstruction/resume coding/shell scenarios. Hosted artifact `reference-e2e-evidence-33854020874` has digest `sha256:220650f1b61b0297ec445ded03bf3a15870514a9482c9e55012ddfba8ae0da2d`; the local run pins runtime digest `sha256:bcd5dbff8b2d108ee7dab464a85ee7d39ef74a8616a6af73a94ebb10ff8eaf75`. This is coding/shell evidence, not Browser E2E |
| Browser-lock Agent Platform candidate regression evidence | hosted harness/Provider `e7e7f03`/`44ea2ee`, run `33854020947`; latest local run `20260904T081706.648122000Z` uses `249cdd4`/`44ea2ee` lock | Hosted and local candidate E2E each passed all 15 initial plus 5 resume coding/shell scenarios, including candidate shadow/selection/rollback/drain policy and reconstruction. Hosted artifact `platform-candidate-e2e-evidence-33854020947` has digest `sha256:48cbe44c433e5b3a858a2691fe1f736469b2e8d71228541f2bdfcc4aab1c15b1`; the local run pins runtime digest `sha256:bcd5dbff8b2d108ee7dab464a85ee7d39ef74a8616a6af73a94ebb10ff8eaf75`. This is candidate integration only, not Browser evidence, real Veronica, or production evidence |
...
| P4 optional-profile authority | Contract `5096e71`; projection/lock `24b2e36`; 48-case Suite; command graph `66183b1`; Browser capacity `7b062e6`; Browser edge `44ea2ee`; Browser caller harness `e7e7f03` | Browser-only capability, create/session/handoff, opaque reference, usage meter, security matrix, admission, default-disabled command composition, process-local Gateway capacity, and hosted 12+5 pre-upgrade edge caller evidence have named evidence. Production advertisement/public Gateway, listener/TLS/HTTP controls, partition-aware shared capacity, distributed durable revocation, remaining profile-specific security/concurrency, aggregate, multi-controller, tenant, deployment, and production gates remain open |
...
| P3 candidate integration evidence | hosted harness/Provider `e7e7f03`/`44ea2ee`, run `33854020947`; latest local evidence `e2e/evidence/platform-candidate/20260904T081706.648122000Z` uses `249cdd4`/`44ea2ee` lock | Hosted and local candidate regressions passed 15+5 coding/shell scenarios against Contract 48 cases. Hosted artifact digest is `sha256:48cbe44c433e5b3a858a2691fe1f736469b2e8d71228541f2bdfcc4aab1c15b1`; local runtime digest is `sha256:bcd5dbff8b2d108ee7dab464a85ee7d39ef74a8616a6af73a94ebb10ff8eaf75`. Boundary is `Agent Platform candidate integration only`; real platform shadow parity, canary traffic, rollback/drain, and platform-contract ownership remain open |
| P2.5i reference external caller | hosted harness/Provider `e7e7f03`/`44ea2ee`, run `33854020874`; latest local evidence `20260904T081521.464863000Z` uses `249cdd4`/`44ea2ee` lock | Hosted and local runs passed 15 initial plus 5 restart/resume coding/shell scenarios. Hosted artifact digest is `sha256:220650f1b61b0297ec445ded03bf3a15870514a9482c9e55012ddfba8ae0da2d`; local runtime digest is `sha256:bcd5dbff8b2d108ee7dab464a85ee7d39ef74a8616a6af73a94ebb10ff8eaf75`. It contains no Browser scenario and proves no Agent Platform, aggregate, multi-controller, hostile multi-tenant, deployment, or production property |
| P4 browser Contract authority and reference caller | Contract `5096e71`; projection/lock `24b2e36`; command `66183b1`; capacity `7b062e6`; edge `44ea2ee`; hosted harness/Provider `e7e7f03`/`44ea2ee`; Browser run `33854020809` | Browser authority, DTO projection, image/runtime components, default-disabled command graph, process-local post-authorization capacity, and hosted 12+5 pre-upgrade edge scenarios pass their named gates. Hosted artifact digest is `sha256:b081ce8a3bf7e3e0c37e4bf036630483735c3812eeaf24d311048ff0a9122779`. Listener/TLS/HTTP limits, partition-aware shared capacity, distributed durable revocation, production advertisement/public Gateway, real platform, aggregate, multi-controller, hostile multi-tenant, deployment, and production evidence remain absent |
...
| P2.5i | Independent reference caller release gate | Hosted run `33854020874` with harness/Provider `e7e7f03`/`44ea2ee` passed 15 initial and 5 restart/resume coding/shell scenarios; latest local run `20260904T081521.464863000Z` passes the same set on `249cdd4`/`44ea2ee` lock | Hosted artifact digest is `sha256:220650f1b61b0297ec445ded03bf3a15870514a9482c9e55012ddfba8ae0da2d`; the local run pins runtime digest `sha256:bcd5dbff8b2d108ee7dab464a85ee7d39ef74a8616a6af73a94ebb10ff8eaf75`. Neither run contains a Browser scenario and neither may be promoted to Agent Platform, aggregate, multi-controller, hostile multi-tenant, deployment, or production evidence |
...
| P4 | Optional capability profiles | Browser Contract authority/projection, exact sandboxed signed linux/amd64 plus linux/arm64/v8 publication, Provider-local components, default-disabled command graph, process-local Gateway capacity, and hosted 12+5 Browser pre-upgrade edge caller evidence have named evidence | Close listener/TLS/HTTP, partition-aware shared capacity, distributed durable revocation, remaining hostile-tenant/operational, and deployment gates before any production advertisement; then begin the Desktop authority audit |
...
`33854020809` provides the complete Browser reference path and both
process-local post-authorization capacity and pre-upgrade service-edge evidence.
