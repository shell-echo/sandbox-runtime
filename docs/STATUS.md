...
| --- | --- | --- |
| Latest verified remote/CI implementation baseline | `9b10abd`; at P2.5c CI completion `main == origin/main` | P2.5c transport, Suite mapping, and local evidence commits are included. Post-push CI `32926181615` (`provider-contract`, `test`, `docker-integration`) passed. Verify the live checkout independently; this evidence baseline is intentionally not a self-updating `HEAD` claim |
