...
| Contract lock | revision `034e6476ff508a0571e64de9ce923799717b902b`; tree `33f1926feb8e12f24a8f92b9e6879102e19c2173`; manifest `sha256:b6a7863bc7a868717d8bb037d386d57228650c915e2d83de3e31129e4d8db64a`; OpenAPI `sha256:08261369d39bb6837759ab4b95f460df3b6c3feb51fbc56d38fe393ce69be2ca`; semantic rules `sha256:b9d3706db2d5c6fa0cfe4a389bb2ad4718daecca076d660c2e7985795e6c1999` | The Provider Calling Standard is a manifest resource. Local verifier and 50-case Conformance pass. Suite file SHA-256 is `1873bc86809d3c4aa214504de483b28ba63bd3d676e81ec2e3194a5ff9aca383`; this is the file hash, not the declared `suite_digest`, which remains the existing placeholder and is not presented as content-derived |
...
- the local Contract verifier proves lock/resource identity, not protocol
  conformance;
- the local Suite runner executes 50 locked admission, lifecycle, exec,
...
The immediate next slice is a content-derived Suite digest and portable remote
black-box conformance runner, followed by qualification of an independently
implemented caller against the exact locked standard. The completed
same-repository reference gate is not that external qualification. Multi-issuer
design, lifecycle-closure gaps, aggregate conformance, multi-controller,
multi-tenant, HA, deployment, and production gates remain separate work before
broad interoperability is claimed.
