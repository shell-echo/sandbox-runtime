...
| P4 optional-profile authority | ADR 0017 and plan `p4-optional-profiles.md` | Browser-first Contract/image/security authority planning is accepted. No optional profile, Provider Contract resource, route, runtime image, or capability advertisement has been added |
...
| P4 | Optional capability profiles | Authority/readiness planning accepted; implementation not started | Add browser, desktop, port forwarding, snapshots/restore, GPU, nested-container, and stronger-isolation profiles only through independent Contract, security, and conformance gates |
