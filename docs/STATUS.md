...
repository CI remains pending. The subsequent P2.5h working tree is based on
`main@0e6e108` and adds explicit canonical-profile opt-in, dependency-absence
