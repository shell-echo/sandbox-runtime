...
| --- | --- | --- |
| Latest Provider implementation evidence | Contract `5096e71`; projection/lock `24b2e36`; browser session `9a5d225`; sandbox/provenance implementation `6e02f1c`; Browser adapter `cd33ba3`; Browser provenance verifier `9390554`; Browser restricted-egress/create-policy `7e60340`; protected transport `b8423f5`; caller-owned Gateway `5aae281`; default-disabled command graph `66183b1`; DNS compatibility Provider `f760369`; Browser Gateway local capacity `7b062e6`; current E2E harness `28a9a5e` | Locks Browser authority, composes the default-disabled Provider-local graph, and bounds total/per-session Gateway connections inside one process without adding production advertisement or a Provider-owned public Gateway. Hosted Browser Reference E2E is recorded separately; pre-upgrade edge control, distributed capacity/revocation, real Agent Platform, aggregate, multi-controller, hostile multi-tenant, deployment, and production claims remain open |
...
| Browser-lock reference regression evidence | current hosted harness/Provider `28a9a5e`/`7b062e6`, run `33846603323`; latest local run `20260904T013909.243838000Z` used earlier lock `9eb32ba`/`5aae281` | Hosted Reference E2E passed all 15 initial and 5 process-reconstruction/resume coding/shell scenarios. Artifact `reference-e2e-evidence-33846603323` has digest `sha256:333be42b84c1d2ebfff86bae7d619348e84d13fe29b6f15975b587c2d38447c3`. This is coding/shell evidence, not Browser E2E |
| Browser-lock Agent Platform candidate regression evidence | current hosted harness/Provider `28a9a5e`/`7b062e6`, run `33846603454`; latest local run `20260904T014037.825223000Z` used earlier lock `9eb32ba`/`5aae281` | Hosted candidate E2E passed all 15 initial plus 5 resume coding/shell scenarios, including candidate shadow/selection/rollback/drain policy and reconstruction. Artifact `platform-candidate-e2e-evidence-33846603454` has digest `sha256:d3148037292f4e883dc96a1e224294f5841a4ae838bc1c8e2fe5e67455d39f95`. This is candidate integration only, not Browser evidence, real Veronica, or production evidence |
...
| P4 optional-profile authority | Contract `5096e71`; projection/lock `24b2e36`; 48-case Suite; command graph `66183b1`; Browser capacity `7b062e6`; Browser caller harness `28a9a5e` | Browser-only capability, create/session/handoff, opaque reference, usage meter, security matrix, admission, default-disabled command composition, process-local Gateway capacity, and hosted reference caller have named evidence. Production advertisement/public Gateway, pre-upgrade edge control, distributed capacity/revocation, remaining profile-specific security/concurrency, aggregate, multi-controller, tenant, deployment, and production gates remain open |
...
| P3 candidate integration evidence | current hosted harness/Provider `28a9a5e`/`7b062e6`, run `33846603454`; latest local evidence `e2e/evidence/20260904T014037.825223000Z` used earlier lock `9eb32ba`/`5aae281` | Hosted current-lock candidate regression passed 15+5 coding/shell scenarios against Contract 48 cases. Artifact digest is `sha256:d3148037292f4e883dc96a1e224294f5841a4ae838bc1c8e2fe5e67455d39f95`. Boundary is `Agent Platform candidate integration only`; real platform shadow parity, canary traffic, rollback/drain, and platform-contract ownership remain open |
| P2.5i reference external caller | current hosted harness/Provider `28a9a5e`/`7b062e6`, run `33846603323`; latest local evidence `20260904T013909.243838000Z` used earlier lock `9eb32ba`/`5aae281` | Hosted current-lock run passed 15 initial plus 5 restart/resume coding/shell scenarios. Artifact digest is `sha256:333be42b84c1d2ebfff86bae7d619348e84d13fe29b6f15975b587c2d38447c3`. It contains no Browser scenario and proves no Agent Platform, aggregate, multi-controller, hostile multi-tenant, deployment, or production property |
| P4 browser Contract authority and reference caller | Contract `5096e71`; projection/lock `24b2e36`; command `66183b1`; capacity `7b062e6`; current harness/Provider `28a9a5e`/`7b062e6`; hosted run `33846603547` | Browser authority, DTO projection, image/runtime components, default-disabled command graph, process-local capacity, and 11 initial plus 5 reconstruction Browser reference-caller scenarios pass their named gates. The artifact digest is `sha256:b024225aa3545fa56a7cc5113f29c0817a86ebc70c3976e10d81bf3507546cba`. Pre-upgrade edge control, distributed capacity/revocation, production advertisement/public Gateway, real platform, aggregate, multi-controller, hostile multi-tenant, deployment, and production evidence remain absent |
...
| P2.5i | Independent reference caller release gate | Hosted run `33846603323` with current harness/Provider `28a9a5e`/`7b062e6` passed 15 initial and 5 restart/resume coding/shell scenarios; latest local run `20260904T013909.243838000Z` remains on earlier lock `9eb32ba`/`5aae281` | Hosted artifact digest is `sha256:333be42b84c1d2ebfff86bae7d619348e84d13fe29b6f15975b587c2d38447c3`. Neither run contains a Browser scenario and neither may be promoted to Agent Platform, aggregate, multi-controller, hostile multi-tenant, deployment, or production evidence |
...
| P4 | Optional capability profiles | Browser Contract authority/projection, exact sandboxed signed linux/amd64 plus linux/arm64/v8 publication, Provider-local components, default-disabled command graph, process-local Gateway capacity, and hosted 11+5 Browser reference caller have named evidence | Close pre-upgrade edge, distributed capacity/revocation, remaining hostile-tenant/operational, and deployment gates before any production advertisement; then begin the Desktop authority audit |
...
- Browser production advertisement and deployable public caller-owned Gateway,
  plus pre-upgrade load shedding/rate limits, distributed capacity/revocation,
...
capacity evidence. Pre-upgrade public-edge limits, distributed
capacity/revocation, production storage/configuration, production Browser
