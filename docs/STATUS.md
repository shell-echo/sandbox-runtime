...
| P1.2.5a | Provider lifecycle composition | PR #27 open; CI `32437976999` passed; awaiting review/merge | Post-merge CI, then retain fake-driver and production-readiness boundaries |
