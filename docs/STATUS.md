...
Product v1 Phase 4 Browser is in progress at **2/13**. Slices 1-2 add Product
Browser session authority, exact Product kind/profile validation, strict
auxiliary Browser-slot mutation/read authority, bounded tenant quota, an
absorbing state machine, PostgreSQL constraints, and Browser-specific outbox
isolation. Eleven slices remain, including Provider adaptation, public
