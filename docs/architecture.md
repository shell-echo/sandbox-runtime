...
durable-revocation caller gate. That gate still requires two Gateway OS processes and
an independent revoker/control process against the same retained backend.
