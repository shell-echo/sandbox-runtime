...
an independent file witness. It has not yet produced a clean local or hosted
run, so no v2 deletion/restore caller evidence, production witness,
HA/failover, production ACL isolation, deployment, or production result exists.
