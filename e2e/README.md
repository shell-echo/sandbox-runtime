...
| Item | Value |
| --- | --- |
| Provider implementation | `7e60340e8bb8d7bbcadded74dee12715d84b120d` |
...
CLI/Sigstore provenance-verifier component, plus the restricted-egress
provisioner and immutable create-policy binding. The reference and
platform-candidate runners still execute only the coding/shell scenarios;
advancing this identity records regression coverage only and is not Browser
external-caller E2E, protected Browser transport, caller-owned Gateway,
...
artifacts are `reference-e2e-evidence-33747803507` (digest
`sha256:c0cf1f430bef0f354423412a15db0de5b6fce0201c3a583402b7fa9dcfc233ad`)
and `platform-candidate-e2e-evidence-33747803514` (digest
...
and `sha256:1ac9282fc77247d2c34a003d184372b58666a2e747bafddaaa138bcecd716873`,
respectively. Their artifact run directories are
`20260903T110613.459807443Z` and `20260903T110608.526760977Z`.
...
The latest recorded lock-refresh run `33747803507` passed Provider `7e60340`
with harness `7f15628` and uploaded `reference-e2e-evidence-33747803507` with
digest
`sha256:c0cf1f430bef0f354423412a15db0de5b6fce0201c3a583402b7fa9dcfc233ad`.
...
The latest recorded lock-refresh run `33747803514` passed Provider `7e60340`
with harness `7f15628` and uploaded
`platform-candidate-e2e-evidence-33747803514` with digest
`sha256:3f85c05e23d84f00d88b41302f7d8fd401579bd7ab07b2464d1f346388eb1f5c`.
