...
func TestValidateObservationRejectsUnboundedOrInconsistentMetadata(t *testing.T) {
	...
	for _, value := range []Observation{
		...
		{Type: ObservationStreamTerminated, Result: ObservationResultUnavailable, MessageType: ObservationMessageNone},
		{Type: ObservationStreamTerminated, Result: ObservationResultFenceLost, MessageType: ObservationMessageText},
		{Type: ObservationStreamTerminated, Result: ObservationResultFenceLost, MessageType: ObservationMessageNone, Bytes: 1},
